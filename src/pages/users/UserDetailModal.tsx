...
import { X, Mail, Phone, Edit, AtSign, ShieldCheck, Store } from 'lucide-react';
          ...
          <div className="w-full space-y-4 text-left bg-background-card p-6 rounded-2xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <AnatomyText.Label className="mb-0">Username</AnatomyText.Label>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <AnatomyText.Label className="mb-0">Email</AnatomyText.Label>
                <p className="text-sm font-medium">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <AnatomyText.Label className="mb-0">Phone</AnatomyText.Label>
                <p className="text-sm font-medium">
                  {user.phone}
                </p>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <AnatomyText.Label className="mb-0">Status</AnatomyText.Label>
                <p className="text-sm font-medium">
                  {user.status}
                </p>
              </div>
            ...
            {user.restaurant && (
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <AnatomyText.Label className="mb-0">Restaurant</AnatomyText.Label>
                  <p className="text-sm font-medium">
